#!/bin/sh
cd /home/cdipasq/geant4/geant4-v11.2.1-install/share/Geant4/geant4make
#-----------------------------------------------------------------------
...
export G4LIB="`cd $geant4make_root/../../../lib/Geant4-11.2.1 > /dev/null ; pwd`"

if [ -z "${LD_LIBRARY_PATH-}" ] ; then
  export LD_LIBRARY_PATH="`cd $geant4make_root/../../../lib > /dev/null ; pwd`"
else
  export LD_LIBRARY_PATH="`cd $geant4make_root/../../../lib > /dev/null ; pwd`":${LD_LIBRARY_PATH}
fi
...
# Resource file paths
# - Datasets
export G4NEUTRONHPDATA="`cd $geant4make_root/../data/G4NDL4.7 > /dev/null ; pwd`"
export G4LEDATA="`cd $geant4make_root/../data/G4EMLOW8.5 > /dev/null ; pwd`"
export G4LEVELGAMMADATA="`cd $geant4make_root/../data/PhotonEvaporation5.7 > /dev/null ; pwd`"
export G4RADIOACTIVEDATA="`cd $geant4make_root/../data/RadioactiveDecay5.6 > /dev/null ; pwd`"
export G4PARTICLEXSDATA="`cd $geant4make_root/../data/G4PARTICLEXS4.0 > /dev/null ; pwd`"
...
export G4ENSDFSTATEDATA="`cd $geant4make_root/../data/G4ENSDFSTATE2.3 > /dev/null ; pwd`"
...
export QT_VERSION=5
export QTHOME=/usr
export QTLIBPATH=/usr/lib/x86_64-linux-gnu
